...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { descricao: @tarefa.descricao, inicio: @tarefa.inicio, nome: @tarefa.nome, previsao: @tarefa.previsao, status: @tarefa.status } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { descricao: @tarefa.descricao, inicio: @tarefa.inicio, nome: @tarefa.nome, previsao: @tarefa.previsao, status: @tarefa.status } }
